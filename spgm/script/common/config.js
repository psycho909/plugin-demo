...
function initialPage(callback, headerOption, otherComponents) {
	requirejs(['moment', 'sweetalert2', 'app', 'pace', 'icheck', 'select2-maxheight', 'datatables.net-responsive', 'datatables-helper', 'daterangepicker', 'form-control', 
		'editForm', 'jquery-serialize', 'jquery-validate-messages', 'card-switcher', 'card-expander'], function(moment, swal) {
